...
//mr pelletier i am very sorry i am handing this in so late
//i also regret that i was not able to come to school the day you were
//talking to people about our projects
//so im telling you about my animation here
//i made use of Pshapes and quads, blinks, the opacity feature, aaaand adding music 
//---------------------
//roll initiative!!!
//this here little sequence is based on a bit of d&d 5e lore
...
//---------------------
//i thought this scene called for some Paul Hindemith tunes
//his stuff is cold and precise, although not without the merit of elegance
//but it is all his own and very specific
//im not sure if im allowed to use the recordings on youtube???
//so i was like aight ill just dub it myself
//i don't have any hindemith solo scores on hand except exam material 
//so the inset music is just...somewhat regretfully...a slice of my exam recording
//it does suit the vibe however (i think)
//i do apologize for the poor audio quality as the track has been recorded
//from a recording and then converted to an mp3
//yikes

//all to do with minim
import ddf.minim.*;
...
void setup() {
  size (1000, 600);
  //minim vars
  stuff = new Minim(this);
  sksdfj = stuff.loadFile("thislldo.mp3");
  //music
  sksdfj.play();
  //my vars
...
void draw() {
  ...
  if (theinescapablegraspoftime > 540) {
    thesecondpass();
    secondx = secondx + 3;
  }

  //scenery elements: three tree layers, dirt, fore-rocks, mist
  //foreground layers of rock gradients and ground
  daTweesnWocks();
}
